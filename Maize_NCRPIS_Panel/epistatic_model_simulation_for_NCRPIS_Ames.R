...
create.simluated.data <- function(){
  ...
  vector.of.epi.QTN <- sample(1:nrow(genotypes.non.monomorphic.5K.subset), (2*Epistatic.QTN.number), replace = FALSE)
...
load("50K.and.15K.5K.GBS.SNPs.for.Ames.2648.Rdata")
